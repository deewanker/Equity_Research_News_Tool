...
if not newsapi_key or not groq_api_key:
...
def summarize_articles(articles):
    summaries = [article.get("description", "No description available") for article in articles[:5]]  # Limit to top 5 articles
    return " ".join(summaries) if summaries else "No relevant news found."
